...
HRESULT hosuk::init(const char* imageName, float x, float y)
{
	...
	this->imageInit();
	ZeroMemory(_px, sizeof(pixelCollision));
...
void hosuk::imageInit()
{
	...
	int arrRightStay = { 17 };
	_enemyInfo.enemyAni[ENEMY_RIGHT_STAYANI]->setPlayFrame(arrRightStay, 1, true);
	_enemyInfo.enemyAni[ENEMY_RIGHT_STAYANI]->setFPS(1);
