...
{
	_demon.image = IMAGEMANAGER->addFrameImage("on_off", "Image/familiar/on_off.bmp", 400, 50, 2, 1, true, RGB(255, 0, 255));
	_fairy.image = IMAGEMANAGER->addFrameImage("on_off1", "Image/familiar/on_off1.bmp", 400, 50, 2, 1, true, RGB(255, 0, 255));
	_ghost.image = IMAGEMANAGER->addFrameImage("on_off2", "Image/familiar/on_off2.bmp", 400, 50, 2, 1, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("on_off3", "Image/familiar/on_off3.bmp", 400, 50, 2, 1, true, RGB(255, 0, 255));
...
{
	IMAGEMANAGER->deleteImage("on_off");
	IMAGEMANAGER->deleteImage("on_off1");
	IMAGEMANAGER->deleteImage("on_off2");
	_demon.image = NULL;
	_fairy.image = NULL;
	_ghost.image = NULL;
