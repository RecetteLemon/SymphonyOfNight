...
HRESULT loading::init()
{
	...
	_background = IMAGEMANAGER->addFrameImage("로딩배경", "image/loading/loadingBackground.bmp",33000, 600, 41, 1, true, RGB(255, 0, 255));
	...
	_loadingBar->init("image/loading/loadingBarTop", "image/loading/loadingBarBottom", WINSIZEX / 2, WINSIZEY - 20, WINSIZEX, 20);
